...
const NurseLoginScreen = ({ navigation }: Nav) => {
        ...
        if (email != '' && pass != '') {
            ...
            await auth()
                ...
                .then(async (user: any) => {
                    ...
                    if (users?.data()?.role == 'nurse') {
                        SignIn({
                            email: users?.data()?.email,
                            nama: users?.data()?.name,
                            role: users?.data()?.role
                        })
                    } else if (users?.data()?.role == 'doctor') {
                        AndroidToast.toast('This account is doctor account!')
                    } else {
                        AndroidToast.toast('This account is admin account!')
                    }
                })
                .catch(error => {
...
export default NurseLoginScreen